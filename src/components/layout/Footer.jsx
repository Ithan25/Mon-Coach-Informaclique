import { Monitor, Phone, Mail, MapPin, Facebook, Linkedin, Instagram, ArrowUp } from 'lucide-react'
                ...
                <div className="py-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
                    ...
                    <div className="lg:col-span-3">
                        ...
                        <ul className="space-y-4">
                            <li>
                                <a href="tel:+33600000000" className="flex items-center gap-3 text-[var(--color-gray-light)] hover:text-white transition-colors group">
